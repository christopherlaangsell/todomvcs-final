...
var G__18809 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__18809,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__18809;
}
});
...
var len__4730__auto___18814 = arguments.length;
var i__4731__auto___18815 = (0);
while(true){
if((i__4731__auto___18815 < len__4730__auto___18814)){
args__4736__auto__.push((arguments[i__4731__auto___18815]));

var G__18816 = (i__4731__auto___18815 + (1));
i__4731__auto___18815 = G__18816;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq18811){
var G__18812 = cljs.core.first.call(null,seq18811);
var seq18811__$1 = cljs.core.next.call(null,seq18811);
var G__18813 = cljs.core.first.call(null,seq18811__$1);
var seq18811__$2 = cljs.core.next.call(null,seq18811__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__18812,G__18813,seq18811__$2);
});
...
var file = cljs.core.get.call(null,map__18818__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__18818__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__18818__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__18818,map__18818__$1,file,line,column){
return (function (p1__18817_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__18817_SHARP_));
});})(map__18818,map__18818__$1,file,line,column))
...
var temp__5457__auto___18820 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___18820)){
var message_18821 = temp__5457__auto___18820;
cljs.core.println.call(null,message_18821);
} else {
}
...
var temp__5457__auto___18822 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___18822)){
var message_18823 = temp__5457__auto___18822;
cljs.core.println.call(null,message_18823);
} else {
}
...
var output_dir__$1 = (function (){var G__18824 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__18824,"/"].join('');
} else {
return G__18824;
}
})();
...
var G__18826 = exception.stack;
var G__18826__$1 = (((G__18826 == null))?null:clojure.string.split_lines.call(null,G__18826));
var G__18826__$2 = (((G__18826__$1 == null))?null:cljs.core.get.call(null,G__18826__$1,depth));
if((G__18826__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__18826__$2);
}
} else {
...
var vec__18827 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__18827,(0),null);
var column = cljs.core.nth.call(null,vec__18827,(1),null);
var vec__18830 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__18830,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__18830,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__18830,(2),null);
...
var m__$1 = (function (){var G__18833 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
var G__18833__$1 = (((G__18833 instanceof cljs.core.Keyword))?G__18833.fqn:null);
switch (G__18833__$1) {
case "fail":
...
var G__18837 = (function (){var G__18836 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__18836);
} else {
return G__18836;
}
})();
...
return cljs.core.vary_meta.call(null,G__18838,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__18842 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__18842,(0),null);
var types = vec__18842;
...
return cljs.core.map.call(null,(function (p__18845){
var vec__18846 = p__18845;
var ns = cljs.core.nth.call(null,vec__18846,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__18846,(1),null);
return ((function (vec__18846,ns,vars__$1){
return (function (){
...
var G__18849 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1){
return (function (){
var seq__18850 = cljs.core.seq.call(null,vars__$1);
var chunk__18851 = null;
var count__18852 = (0);
var i__18853 = (0);
while(true){
if((i__18853 < count__18852)){
var v = cljs.core._nth.call(null,chunk__18851,i__18853);
var temp__5457__auto___18855 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___18855)){
var t_18856 = temp__5457__auto___18855;
each_fixture_fn.call(null,((function (seq__18850,chunk__18851,count__18852,i__18853,t_18856,temp__5457__auto___18855,v,each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_18856)));
});})(seq__18850,chunk__18851,count__18852,i__18853,t_18856,temp__5457__auto___18855,v,each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1))
);
} else {
}


var G__18857 = seq__18850;
var G__18858 = chunk__18851;
var G__18859 = count__18852;
var G__18860 = (i__18853 + (1));
seq__18850 = G__18857;
chunk__18851 = G__18858;
count__18852 = G__18859;
i__18853 = G__18860;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__18850);
if(temp__5457__auto__){
var seq__18850__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__18850__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__18850__$1);
var G__18861 = cljs.core.chunk_rest.call(null,seq__18850__$1);
var G__18862 = c__4550__auto__;
var G__18863 = cljs.core.count.call(null,c__4550__auto__);
var G__18864 = (0);
seq__18850 = G__18861;
chunk__18851 = G__18862;
count__18852 = G__18863;
i__18853 = G__18864;
continue;
} else {
var v = cljs.core.first.call(null,seq__18850__$1);
var temp__5457__auto___18865__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___18865__$1)){
var t_18866 = temp__5457__auto___18865__$1;
each_fixture_fn.call(null,((function (seq__18850,chunk__18851,count__18852,i__18853,t_18866,temp__5457__auto___18865__$1,v,seq__18850__$1,temp__5457__auto__,each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_18866)));
});})(seq__18850,chunk__18851,count__18852,i__18853,t_18866,temp__5457__auto___18865__$1,v,seq__18850__$1,temp__5457__auto__,each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1))
);
} else {
}


var G__18867 = cljs.core.next.call(null,seq__18850__$1);
var G__18868 = null;
var G__18869 = (0);
var G__18870 = (0);
seq__18850 = G__18867;
chunk__18851 = G__18868;
count__18852 = G__18869;
i__18853 = G__18870;
continue;
}
} else {
...
});})(each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1))
);
});})(each_fixture_fn,G__18849,G__18849__$1,env,once_fixtures,each_fixtures,vec__18846,ns,vars__$1))
], null);
