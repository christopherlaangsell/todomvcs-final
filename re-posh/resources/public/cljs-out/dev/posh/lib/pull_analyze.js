...
return cljs.core.vec.call(null,cljs.core.map.call(null,(function (p1__8204_SHARP_){
if(cljs.core.coll_QMARK_.call(null,p1__8204_SHARP_)){
return posh.lib.pull_analyze.insert_dbid.call(null,p1__8204_SHARP_);
} else {
return p1__8204_SHARP_;
}
...
var temp__5457__auto__ = cljs.core.get.call(null,schema,attr);
...
var vec__8208 = cljs.core.first.call(null,pull_map);
...
})())?cljs.core.concat.call(null,(((!(r_QMARK_)))?cljs.core.mapcat.call(null,((function (vec__8208,k,v,r_QMARK_,k__$1){
return (function (p1__8205_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__8205_SHARP_)], null)],null));
});})(vec__8208,k,v,r_QMARK_,k__$1))
,v):null),cljs.core.mapcat.call(null,((function (vec__8208,k,v,r_QMARK_,k__$1){
return (function (p1__8206_SHARP_){
return posh.lib.pull_analyze.tx_datoms_for_pull_map.call(null,schema,new cljs.core.Keyword("db","id","db/id",-1388397098).cljs$core$IFn$_invoke$arity$1(p1__8206_SHARP_),cljs.core.merge.call(null,((r_QMARK_)?cljs.core.PersistentArrayMap.createAsIfByAssoc([k__$1,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("db","id","db/id",-1388397098),entity_id], null)]):null),p1__8206_SHARP_));
});})(vec__8208,k,v,r_QMARK_,k__$1))
...
return cljs.core.concat.call(null,(cljs.core.truth_(posh.lib.pull_analyze.cardinality_many_QMARK_.call(null,schema,k__$1))?cljs.core.mapcat.call(null,((function (vec__8208,k,v,r_QMARK_,k__$1){
return (function (p1__8207_SHARP_){
return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [entity_id,k__$1,p1__8207_SHARP_], null)],null));
});})(vec__8208,k,v,r_QMARK_,k__$1))
...
var entity_keys = cljs.core.remove.call(null,(function (p1__8211_SHARP_){
return ((cljs.core.map_QMARK_.call(null,p1__8211_SHARP_)) || (cljs.core._EQ_.call(null,new cljs.core.Keyword("db","id","db/id",-1388397098),p1__8211_SHARP_)));
}),pull_pattern);
var val_keys = cljs.core.remove.call(null,((function (entity_keys){
return (function (p1__8212_SHARP_){
return ((posh.lib.pull_analyze.reverse_lookup_QMARK_.call(null,p1__8212_SHARP_)) || (posh.lib.pull_analyze.ref_QMARK_.call(null,schema,p1__8212_SHARP_)));
});})(entity_keys))
,entity_keys);
...
return (function (p__8215){
var vec__8216 = p__8215;
var ref_key = cljs.core.nth.call(null,vec__8216,(0),null);
var ref_pull = cljs.core.nth.call(null,vec__8216,(1),null);
...
})())?cljs.core.mapcat.call(null,((function (r_QMARK_,unrev_key,vec__8216,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps){
return (function (p1__8214_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,ref_pull,p1__8214_SHARP_,refs_only_QMARK_);
});})(r_QMARK_,unrev_key,vec__8216,ref_key,ref_pull,entity_keys,val_keys,ref_keys,starred_QMARK_,pull_maps))
...
posh.lib.pull_analyze.pull_analyze = (function posh$lib$pull_analyze$pull_analyze(dcfg,retrieve,p__8219,pull_pattern,ent_id){
...
var db = cljs.core.get.call(null,map__8220__$1,new cljs.core.Keyword(null,"db","db",993250759));
var db_id = cljs.core.get.call(null,map__8220__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
var schema = cljs.core.get.call(null,map__8220__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
...
posh.lib.pull_analyze.pull_many_analyze = (function posh$lib$pull_analyze$pull_many_analyze(dcfg,retrieve,p__8225,pull_pattern,ent_ids){
...
var db = cljs.core.get.call(null,map__8226__$1,new cljs.core.Keyword(null,"db","db",993250759));
var schema = cljs.core.get.call(null,map__8226__$1,new cljs.core.Keyword(null,"schema","schema",-1582001791));
var db_id = cljs.core.get.call(null,map__8226__$1,new cljs.core.Keyword(null,"db-id","db-id",747248515));
if(cljs.core.empty_QMARK_.call(null,retrieve)){
return null;
} else {
var resolved_ent_ids = cljs.core.map.call(null,((function (map__8226,map__8226__$1,db,schema,db_id){
return (function (p1__8222_SHARP_){
return new cljs.core.Keyword(null,"entid","entid",1720688982).cljs$core$IFn$_invoke$arity$1(dcfg).call(null,db,p1__8222_SHARP_);
});})(map__8226,map__8226__$1,db,schema,db_id))
,ent_ids);
...
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"results","results",-1134170113),affected_datoms], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null,new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?(function (){var datoms = cljs.core.mapcat.call(null,((function (resolved_ent_ids,affected_datoms,map__8226,map__8226__$1,db,schema,db_id){
return (function (p1__8223_SHARP_){
return posh.lib.pull_analyze.generate_affected_tx_datoms_for_pull.call(null,schema,p1__8223_SHARP_);
});})(resolved_ent_ids,affected_datoms,map__8226,map__8226__$1,db,schema,db_id))
,affected_datoms);
return cljs.core.merge.call(null,(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms","datoms",-290874434),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,datoms])], null):null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"datoms-t","datoms-t",1641690868),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,posh.lib.util.t_for_datoms.call(null,new cljs.core.Keyword(null,"q","q",689001697).cljs$core$IFn$_invoke$arity$1(dcfg),db,datoms)])], null):null));
})():null),(cljs.core.truth_(cljs.core.some.call(null,new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),null], null), null),retrieve))?new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"patterns","patterns",1164082024),cljs.core.PersistentArrayMap.createAsIfByAssoc([db_id,(function (){var patterns = cljs.core.map.call(null,((function (resolved_ent_ids,affected_datoms,map__8226,map__8226__$1,db,schema,db_id){
return (function (p1__8224_SHARP_){
return posh.lib.pull_analyze.tx_pattern_for_pull.call(null,schema,posh.lib.pull_analyze.insert_dbid.call(null,posh.lib.pull_analyze.remove_limits.call(null,pull_pattern)),p1__8224_SHARP_,false);
});})(resolved_ent_ids,affected_datoms,map__8226,map__8226__$1,db,schema,db_id))
,affected_datoms);
