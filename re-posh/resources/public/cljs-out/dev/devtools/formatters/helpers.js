...
var G__20109 = devtools.prefs.pref.call(null,v);
v = G__20109;
continue;
} else {
return v;
...
}catch (e20112){var _e__19121__auto__ = e20112;
return false;
}})();
...
}catch (e20116){var _e__19121__auto__ = e20116;
return false;
}})();
...
}catch (e20118){var _e__19121__auto__ = e20118;
return false;
}}
}
});
...
var vec__20120 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__20120,(0),null);
var name = cljs.core.nth.call(null,vec__20120,(1),null);
...
return cljs.core.some.call(null,(function (p1__20123_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__20123_SHARP_);
}),template);
});
