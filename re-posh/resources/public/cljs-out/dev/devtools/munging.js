...
var o20004 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20004["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20005 = temp__5455__auto____$1;
return (o20005["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__19114__auto__ = f;
return (o__19114__auto__["toString"]).call(o__19114__auto__);
} else {
return "";
}
...
try{var o__19114__auto___20008 = t;
(o__19114__auto___20008["cljs$lang$ctorPrWriter"]).call(o__19114__auto___20008,t,writer);
}catch (e20007){var __20009 = e20007;
}
...
var char_code = (function (){var o__19114__auto__ = (new String(char$));
return (o__19114__auto__["charCodeAt"]).call(o__19114__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__19114__auto__ = String;
return (o__19114__auto__["fromCharCode"]).call(o__19114__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20010 = num_code;
switch (G__20010) {
case (1):
return (185);
...
var o__19114__auto__ = String;
return (o__19114__auto__["fromCharCode"]).call(o__19114__auto__,superscript_code);
});
/**
...
}catch (e20012){var _e__19121__auto__ = e20012;
return false;
}})())){
...
var vec__20013 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20013,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20016 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20016["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20017 = temp__5455__auto____$1;
return (o20017["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20020){
var vec__20021 = p__20020;
var ns_detector = cljs.core.nth.call(null,vec__20021,(0),null);
...
var G__20027 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20028 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20027;
remaining_tokens = G__20028;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20018){
var G__20019 = cljs.core.first.call(null,seq20018);
var seq20018__$1 = cljs.core.next.call(null,seq20018);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20019,seq20018__$1);
});
...
var vec__20032 = cljs.core.split_with.call(null,(function (p1__20031_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20031_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20032,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20032,(1),null);
...
var vec__20038 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20038,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20038,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20041 = cljs.core.rest.call(null,remaining_tokens);
var G__20042 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20041;
name_tokens = G__20042;
continue;
} else {
...
var vec__20045 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20045,(0),null);
var arity = cljs.core.nth.call(null,vec__20045,(1),null);
var vec__20048 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20048,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20048,(1),null);
var vec__20051 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20051,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20051,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20051,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20051,(3),null);
...
var vec__20057 = result;
var munged_ns = cljs.core.nth.call(null,vec__20057,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20057,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20057,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20057,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20057,(4),null);
var arity = cljs.core.nth.call(null,vec__20057,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20061 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20061,(0),null);
var args = cljs.core.nth.call(null,vec__20061,(1),null);
var vec__20064 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20064,(0),null);
var name = cljs.core.nth.call(null,vec__20064,(1),null);
...
var G__20067 = (arity + (1));
var G__20068 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20069){
var vec__20070 = p__20069;
var arity = cljs.core.nth.call(null,vec__20070,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20070,(1),null);
...
return cljs.core.get.call(null,arities,p1__20073_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20074_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20077){
var vec__20078 = p__20077;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20078,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20075){
var G__20076 = cljs.core.first.call(null,seq20075);
var seq20075__$1 = cljs.core.next.call(null,seq20075);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20076,seq20075__$1);
});
...
var map__20086 = options;
var map__20086__$1 = (((((!((map__20086 == null))))?(((((map__20086.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20086.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20086):map__20086);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20086__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20086__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20086__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20086__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20087 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20087,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20087,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20087,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20087,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20087,(4),null);
var arity = cljs.core.nth.call(null,vec__20087,(5),null);
...
var o__19114__auto__ = f;
return (o__19114__auto__["getBasis"]).call(o__19114__auto__);
});
/**
...
}catch (e20091){var _e__19121__auto__ = e20091;
...
var G__20092 = (obj[cljs.core.first.call(null,path)]);
var G__20093 = cljs.core.rest.call(null,path);
obj = G__20092;
path = G__20093;
continue;
} else {
...
return (function (accum,p__20094){
var vec__20095 = p__20094;
var bit = cljs.core.nth.call(null,vec__20095,(0),null);
var protocol = cljs.core.nth.call(null,vec__20095,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20098){
var vec__20099 = p__20098;
var ns = cljs.core.nth.call(null,vec__20099,(0),null);
var name = cljs.core.nth.call(null,vec__20099,(1),null);
var selector = cljs.core.nth.call(null,vec__20099,(2),null);
...
return (function (p__20103){
var vec__20104 = p__20103;
var munged_name = cljs.core.nth.call(null,vec__20104,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20104,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20102_SHARP_){
return (obj[cljs.core.first.call(null,p1__20102_SHARP_)]);
});})(name,sorted_matches,vec__20104,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
