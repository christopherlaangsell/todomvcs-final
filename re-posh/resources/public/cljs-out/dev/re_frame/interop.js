...
return [(function (){var pred__10687 = cljs.core.instance_QMARK_;
var expr__10688 = reactive_val;
if(cljs.core.truth_(pred__10687.call(null,reagent.ratom.RAtom,expr__10688))){
return "ra";
} else {
if(cljs.core.truth_(pred__10687.call(null,reagent.ratom.RCursor,expr__10688))){
return "rc";
} else {
if(cljs.core.truth_(pred__10687.call(null,reagent.ratom.Reaction,expr__10688))){
return "rx";
} else {
if(cljs.core.truth_(pred__10687.call(null,reagent.ratom.Track,expr__10688))){
return "tr";
} else {
return "other";
}
